...
const BrokerInfoContainer = styled.div`
  background-color: ${AppColors.surfaceVariant};
  border-radius: ${AppRadius.md}px;
  padding: ${AppSpacing.lg}px;
  border: 1px solid ${AppColors.border};
    ...
    <ModalOverlay onClick={onClose}>
      <ModalContent onClick={(e) => e.stopPropagation()}>
        ...
        <Section>
          ...
          <BrokerInfoContainer>
            <BrokerDescription>
              This app provides real-time trading insights and educational examples generated by a neural network model.
            </BrokerDescription>
            <BrokerDescription>
              These insights are designed for learning and analysis purposes only, not as financial advice or trade recommendations.
            </BrokerDescription>
            <BrokerDescription>
              The broker information below is shared to provide transparency about the trading environment used during the analysis.
            </BrokerDescription>
            <BrokerButton onClick={() => window.open('https://forexradar7.com/broker', '_blank', 'noopener,noreferrer')}>
              ℹ️ View Broker Information
            </BrokerButton>
            <BrokerLinkText>
              Learn more about the broker used in this app's data environment.
            </BrokerLinkText>
          </BrokerInfoContainer>
        </Section>
      </ModalContent>
